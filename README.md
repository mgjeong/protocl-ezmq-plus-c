...
## How to build
1. Go to ~/protocol-ezmq-plus-c/out/linux/{ARCH}/{MODE}/samples/docker
2. Build the docker image:
   ```
   $ ./build.sh
   ```
**Notes:** </br>
(1) It will build the docker image [**docker.sec.samsung.net:5000/protocol-ezmq-plus-c-sample**] for ezmq-plus samples. </br>
...
1. Run the sample:
    ```
    $ docker run docker.sec.samsung.net:5000/protocol-ezmq-plus-c-sample /run.sh topicdiscovery /topic
    ```
...
1. Run the sample:
    ```
    $ docker run docker.sec.samsung.net:5000/protocol-ezmq-plus-c-sample /run.sh publisher /topic
    ```
**Note:** Update the **/topic**, with topic of interest.
...
1. Run the sample:
    ```
    $ docker run docker.sec.samsung.net:5000/protocol-ezmq-plus-c-sample /run.sh amlsubscriber /topic
    ```
**Note:** Update the **/topic**, with topic of interest.
...
1. Run the sample:
    ```
    $ docker run docker.sec.samsung.net:5000/protocol-ezmq-plus-c-sample /run.sh xmlsubscriber /topic
    ```
**Note:** Update the **/topic**, with topic of interest.
